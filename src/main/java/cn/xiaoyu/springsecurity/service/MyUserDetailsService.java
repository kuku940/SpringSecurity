...
public class MyUserDetailsService implements UserDetailsService {
     ...
     */
    private static final List<MyUserBean> beans = init();
    ...
    private MyUserBean selectByUsername(String username) {
        return beans.stream().filter(user -> username.equals(user.getUsername())).findFirst().orElse(null);
    }

    private static List<MyUserBean> init() {
